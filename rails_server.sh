...
function tipOne {
  echo "Remeber: after the installation of PostgreSQL do a change in /etc/postgresql/[version]/main/pg_hba.conf"
  echo "change line "
...
function install-all {
  sudo apt install -y build-essential dirmngr gnupg ruby ruby-dev zlib1g-dev libssl libruby-dev libpcre3-dev libcurl4-openssl-dev rake ruby-rack nodejs
  gpg --keyserver hkp://keys.gnupg.net --recv-keys 409B6B1796C275462A1703113804BB82D39DC0E3 7D2BAF1CF37B13E2069D6956105BD0E739499BDB
  sudo apt update
  sudo apt install -y dirmngr curl
